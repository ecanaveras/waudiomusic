...
public class DataFirebaseHelper {
    ...
    private static final String REF_WAUDIO_STORE = "waudio-store";
    private static final String REF_WAUDIO_EVENTS = "waudio-events";
    private static final String REF_WAUDIO_TEMPLATES = "waudio-templates";
