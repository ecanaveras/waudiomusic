...
public class ShortenExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Movie movie = MovieCreator.build("D:\\DEV\\tmp\\mp4parser\\video_in.mp4");
        ...
        FileOutputStream fos = new FileOutputStream("D:\\DEV\\tmp\\mp4parser\\" + String.format("output-%f-%f--%f-%f.mp4", startTime1, endTime1, startTime2, endTime2));
        ...
        System.err.println("Writing IsoFile speed : " + (new File("D:\\DEV\\tmp\\mp4parser\\" + String.format("output-%f-%f--%f-%f.mp4", startTime1, endTime1, startTime2, endTime2)).length() / (start3 - start2) / 1000) + "MB/s");
    }
